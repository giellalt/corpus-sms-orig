...
<xsl:variable name="title" select="'Lää ́ddjânnam serdd eurru'"/>
...
<xsl:variable name="mlang_smn" select="''"/>
...
<xsl:variable name="smnlang" select="'smn'"/>
...
<xsl:variable name="para_swe" select="'euro_koltta_sami.pdf'"/>
