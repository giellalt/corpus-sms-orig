...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1412&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sääʹmaaʹšši vaʹstteei ministeerji da presideenti sååbbar Tukholmast skamm`mannu 22. peeiʹv 2010'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="poytakirjasuomeksi.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="index.php_option=com_docman_task=doc_download_gid=1410_itemid=10.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="index.php_option=com_docman_task=doc_download_gid=1411_itemid=10.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'1=42'"/>
