...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1677&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tät lij automaattlaž vasttõs.'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="ulkona-tilan_viesteja_-_mallilausekkeet_2011_su-da-an-nu-en-logov3.pdf"/>
        <parallel_text xml:lang="fin" location="ulkona-tilan_viesteja_-_mallilausekkeet_2011_su-da-an-nu-en-logov3.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="ulkona-tilan_viesteja_-_mallilausekkeet_2011_su-da-an-nu-en-logov3.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="ulkona-tilan_viesteja_-_mallilausekkeet_2011_su-da-an-nu-en-logov3.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=62'"/>
    <xsl:variable name="bottom_margin" select="'1=26'"/>
