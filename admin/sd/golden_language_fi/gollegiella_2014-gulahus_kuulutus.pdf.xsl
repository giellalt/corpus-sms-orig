...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2348&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tâʹvvjânnmlaž sääʹmǩiõl ǩiõllcistt jueʹjjet čâhčča 2014'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="gollegiella_2014-gulahus_kuulutus.pdf"/>
        ...
        <parallel_text xml:lang="nob" location="gollegiella_2014-gulahus_kuulutus.pdf"/>
        <parallel_text xml:lang="rus" location="gollegiella_2014-gulahus_kuulutus.pdf"/>
        <parallel_text xml:lang="sma" location="gollegiella_2014-gulahus_kuulutus.pdf"/>
        <parallel_text xml:lang="sme" location="gollegiella_2014-gulahus_kuulutus.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="gollegiella_2014-gulahus_kuulutus.pdf"/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location="gollegiella_2014-gulahus_kuulutus.pdf"/>
    </xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2,4-9'"/>
    ...
    <xsl:variable name="top_margin" select="'3=11'"/>
    <xsl:variable name="bottom_margin" select="'3=36'"/>
