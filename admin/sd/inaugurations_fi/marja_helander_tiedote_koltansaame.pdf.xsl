...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Čeäppõstuejjõõzz Sää´mkultturkõõskõs Sajoozzâst'"/>
    <xsl:variable name="author1_fn" select="'Marja'"/>
    <xsl:variable name="author1_ln" select="'Helander'"/>
    ...
    <parallel_text location="marja_helander_tiedote_pohjoissaame.pdf" xml:lang="sme"/>
<parallel_text location="marja_helander_tiedote_suomi.pdf" xml:lang="fin"/>
<parallel_text location="marja_helander_tiedote_inarinsaame.pdf" xml:lang="smn"/>
</xsl:variable>
    ...
    <xsl:variable name="bottom_margin" select="'1=11'"/>
