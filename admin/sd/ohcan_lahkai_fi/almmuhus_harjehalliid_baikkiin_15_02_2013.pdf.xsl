...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2034&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kolmm mätt’tõõttâmpääi´ǩ liâ ooccâmnalla Sää´mtee´ǧǧ piizarkåå´ddest Sajoozzâst Aanrest'"/>
    ...
    <parallel_text location="almmuhus_harjehalliid_baikkiin_15_02_2013.pdf" xml:lang="smn"/>
<parallel_text location="almmuhus_harjehalliid_baikkiin_15_02_2013.pdf" xml:lang="sme"/>
<parallel_text location="almmuhus_harjehalliid_baikkiin_15_02_2013.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1,2,4'"/>
    ...
    <xsl:variable name="top_margin" select="'3=12'"/>
    <xsl:variable name="bottom_margin" select="'3=45'"/>
