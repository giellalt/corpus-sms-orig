...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sää´mte´ǧǧ oudd teâttan, što puõ´tti tuâjjpäI´ǩǩ lij ooccâmnalla vaaldšemšuurmõõžž vee´rj'"/>
    ...
    <parallel_text location="hallpa_virkahaku_2015.pdf" xml:lang="sme"/>
<parallel_text location="hallpa_virkahaku_2015.pdf" xml:lang="smn"/>
<parallel_text location="hallpa_virkahaku_2015.pdf" xml:lang="fin"/>
</xsl:variable>
