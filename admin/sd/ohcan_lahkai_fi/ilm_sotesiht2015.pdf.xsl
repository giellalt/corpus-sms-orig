...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2583&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sääʹmteʹǧǧ oudd teâttân, što ooccamnalla lij mieʹrräiggaž aaʹššI ouʹddepuʹhtti'"/>
    ...
    <parallel_text location="ilm_sotesiht2015.pdf" xml:lang="smn"/>
<parallel_text location="ilm_sotesiht2015.pdf" xml:lang="sme"/>
<parallel_text location="ilm_sotesiht2015.pdf" xml:lang="fin"/>
</xsl:variable>
