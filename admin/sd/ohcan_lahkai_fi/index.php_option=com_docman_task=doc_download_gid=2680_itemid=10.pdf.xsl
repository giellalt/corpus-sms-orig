...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2680&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tuâi praksiizz čõõđtem diõtt Lääʹddjânnam Sääʹmteʹǧǧ ååcc ǩiõlltuâjjla'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="giellagaldu_kielityontekijat_haettavana_suomi.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="index.php_option=com_docman_task=doc_download_gid=2682_itemid=10.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="index.php_option=com_docman_task=doc_download_gid=2681_itemid=10.pdf"/>
