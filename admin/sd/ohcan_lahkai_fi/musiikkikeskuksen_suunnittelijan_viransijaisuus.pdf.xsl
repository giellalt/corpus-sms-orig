...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2534&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sääʹmteʹǧǧ oudd teâttân, što pueʹtti mieʹrräiggsaž plaanraajji sâjjõsvuõtt lij ooccâmnalla Sääʹmteeʹǧǧ sääʹmmusikk-kõõskõõzz mieʹrräiggsaž plaanraajji sâjjõsvuõđ'"/>
    <!--
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="template_version" select="'$Revision: 125457 $'"/>
    <!-- Automatically filled in by CorpusTools -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="musiikkikeskuksen_suunnittelijan_viransijaisuus.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="musiikkikeskuksen_suunnittelijan_viransijaisuus.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="musiikkikeskuksen_suunnittelijan_viransijaisuus.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=72'"/>
    <xsl:variable name="bottom_margin" select="'2=83'"/>
