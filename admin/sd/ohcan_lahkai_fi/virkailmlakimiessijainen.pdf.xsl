...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2142&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sää ́mte ́ǧǧ oudd teâttan, što puõ ́tti tuâjjpäI ́ǩǩ kåå ́tt lij ooccâmnalla, lij lää ́ǩǩpiisar ve ́rǧǧsâjjõsvuõtt da sâjjõsvuõtt älgg 1.10.2013 da peštt – 31.7.2014 räjja'"/>
    ...
    <parallel_text location="virkailmlakimiessijainen.pdf" xml:lang="smn"/>
<parallel_text location="virkailmlakimiessijainen.pdf" xml:lang="sme"/>
<parallel_text location="virkailmlakimiessijainen.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'1=79'"/>
    <xsl:variable name="bottom_margin" select="'2=71'"/>
