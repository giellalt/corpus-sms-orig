...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1881&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sää ́mkultturkõõskõs sajoozz vä ́lddõõ ́nni sää ́mte ́ǧǧ ååcc Sajo ́sse ää ́ššlažvuä ́psteei'"/>
    ...
    <parallel_text location="virkailmsajosinfotyontekija070512.pdf" xml:lang="smn"/>
<parallel_text location="virkailmsajosinfotyontekija070512.pdf" xml:lang="sme"/>
<parallel_text location="virkailmsajosinfotyontekija070512.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <xsl:variable name="bottom_margin" select="'2=59'"/>
