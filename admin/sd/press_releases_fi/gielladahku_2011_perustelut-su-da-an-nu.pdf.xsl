...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1707&amp;Itemid=10'"/>
    ...
    <parallel_text location="gielladahku_2011_perustelut-su-da-an-nu.pdf" xml:lang="smn"/>
<parallel_text location="gielladahku_2011_perustelut-su-da-an-nu.pdf" xml:lang="sme"/>
<parallel_text location="gielladahku_2011_perustelut-su-da-an-nu.pdf" xml:lang="fin"/>
</xsl:variable>
