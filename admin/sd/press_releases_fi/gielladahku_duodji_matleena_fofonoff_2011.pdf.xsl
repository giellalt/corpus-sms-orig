...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1708&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vueʹddin njõđđum vuäʹddčuʹǩǩ looʹǩǩin, vuäʹddtiskk da säähharneʹcc'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="gielladahku_duodji_matleena_fofonoff_2011.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="gielladahku_duodji_matleena_fofonoff_2011.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="gielladahku_duodji_matleena_fofonoff_2011.pdf"/>
    ...
    <xsl:variable name="inner_top_margin" select="'2=40'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=26'"/>
