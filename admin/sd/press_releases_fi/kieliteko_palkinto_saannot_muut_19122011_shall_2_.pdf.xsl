...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1910&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sää ́m ǩiõlltuâjj –ciist šeâttmõõžž'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kieliteko_palkinto_saannot_muut_19122011_shall_2_.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="kieliteko_palkinto_saannot_muut_19122011_shall_2_.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="kieliteko_palkinto_saannot_muut_19122011_shall_2_.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1,2,5'"/>
    ...
    <xsl:variable name="top_margin" select="'3=55'"/>
    <xsl:variable name="bottom_margin" select="'4=39'"/>
