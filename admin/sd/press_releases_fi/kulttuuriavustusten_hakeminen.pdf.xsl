...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=816&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kulttuurveä ́ljljtie ́dždžI ooccmõš'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kulttuuriavustusten_hakeminen.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="kulttuuriavustusten_hakeminen.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="kulttuuriavustusten_hakeminen.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'2=47'"/>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'ǈ/Ǉ/ǉ/Ǐ/ǆ/ǅ/ ́/´/′/´/'"/>
                <xsl:with-param name="replacement" select="'Ǩ/ǧ/ǩ/ǯ/Ǧ/ǥ/ʹ/ʹ/ʹ/ʹ/'"/>
                <xsl:with-param name="continue" select="0"/>
            </xsl:call-template>
        </xsl:element>
    </xsl:template>
