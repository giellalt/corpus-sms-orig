...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1009&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saa ́mi päärnaikulttuurkõõskõs bie ́ǩǩen sää ́mjânnam päärnaikulttuursääi ́m alttii ođđ viiđee ́ǩǩpââi!'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="lastenkultkesk09.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="lastenkultkesk09.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1,2'"/>
    ...
    <xsl:variable name="bottom_margin" select="'3=30'"/>
