...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=217&amp;Itemid=10'"/>
    ...
    <parallel_text location="tiadattas_140408.pdf" xml:lang="smn"/>
<parallel_text location="saamelaiskulttuurikeskus_140408_tiedote.pdf" xml:lang="fin"/>
<parallel_text location="diedahus_140408.pdf" xml:lang="sme"/>
</xsl:variable>
