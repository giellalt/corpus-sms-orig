...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1430&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saa ́mnuõri čeä ́ppvuõđpei ́vv 2011 Uccjooǧǧâst'"/>
    ...
    <parallel_text location="saamelaisnuorten_taidetapahtuma_-_tiedote_011210.pdf" xml:lang="smn"/>
<parallel_text location="saamelaisnuorten_taidetapahtuma_-_tiedote_011210.pdf" xml:lang="sme"/>
<parallel_text location="saamelaisnuorten_taidetapahtuma_-_tiedote_011210.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'2=24'"/>
    <xsl:variable name="bottom_margin" select="'2=44'"/>
