...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1403&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sää ́mtee ́ǧǧ rämmše tâ ́vvjânnamlaž sää ́msuåppmõõžž priimmâm ouddnumuužžâst'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="samekonv_die_ahus_suomi.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="tiedote_pohjoissaame.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="samekonv_die_ahus_inarinsaame.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=20,2=7'"/>
    <xsl:variable name="bottom_margin" select="'2=72'"/>
