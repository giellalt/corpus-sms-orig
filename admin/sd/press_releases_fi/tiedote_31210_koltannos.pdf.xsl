...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1427&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saa ́mi kultturpreeddan suejj âlgg pue ́reed'"/>
    ...
    <parallel_text location="tiedote_saamelaisen_kulttuuriperinnon_suoja_v48.pdf" xml:lang="sme"/>
<parallel_text location="tiedote_31210_inarinsaame.pdf" xml:lang="smn"/>
<parallel_text location="tiedote_31210.pdf" xml:lang="fin"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'1=10,2=6'"/>
    <xsl:variable name="bottom_margin" select="'1=8,2=69'"/>
