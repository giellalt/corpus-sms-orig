...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=972&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sää ́mtee ́ǧǧI takaisååbbar cie ́lǩI algg-ha ́ŋǩǩõõzzâst'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tiedote_alku_paatos.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="tiedote_alku-hanke_paatos_pohjoissaame.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="tiedote_alku_paatos_inarinsaame.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=12,2=6'"/>
    <xsl:variable name="bottom_margin" select="'1=7,2=30'"/>
