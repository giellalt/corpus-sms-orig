...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=985&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sää ́mte ́ǧǧ lij ceälkkam valdiasåbbar ooumâžvuõiggâdvuõttpolitiikklaž čiõlggeemtuâjast'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tiedote_ihmisoikeuspoliittinen_selonteko.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="tiedote_ihmisoikeuspoliittinen_selonteko_psaame.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="tiedote_ihmisoikeuspoliittinen_selonteko_inarinsaame.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=11,2=6'"/>
    <xsl:variable name="bottom_margin" select="'1=8,2=58'"/>
