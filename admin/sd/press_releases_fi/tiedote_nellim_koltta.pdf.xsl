...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1091&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Njeä ́llem meä ́ccreeidai suåppmõš'"/>
    ...
    <parallel_text location="tiedote_nellim_090901.pdf" xml:lang="fin"/>
<parallel_text location="tiedote_nellim_davvis.pdf" xml:lang="sme"/>
<parallel_text location="tiedote_nellim_inarinsaame.pdf" xml:lang="smn"/>
</xsl:variable>
