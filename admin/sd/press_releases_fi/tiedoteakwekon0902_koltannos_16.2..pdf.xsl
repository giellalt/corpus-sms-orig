...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1469&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pää ́nntuõddâr håidd- da ââ ́nnemplaanâst te ́stteet Akwé:Kon –vuä ́pstemvuõđ'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tiedoteakwekon0902.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="diedahus_akwekon090211.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="tiedoteakwekon0902_inarinsaame.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'all=9'"/>
    <xsl:variable name="bottom_margin" select="'1=16'"/>
