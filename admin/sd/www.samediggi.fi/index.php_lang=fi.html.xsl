...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?lang=fi'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_lang=fi.html" xml:lang="eng"/>
	<parallel_text location="index.php_lang=fi.html" xml:lang="fin"/>
	<parallel_text location="index.php_lang=fi.html" xml:lang="sme"/>
	<parallel_text location="index.php_lang=fi.html" xml:lang="smn"/>
</xsl:variable>
