...
<xsl:variable name="parallels">
	<parallel_text location="index.php_lang=fi" xml:lang="eng"/>
	<parallel_text location="index.php_lang=fi" xml:lang="fin"/>
	<parallel_text location="index.php_lang=fi" xml:lang="sme"/>
	<parallel_text location="index.php_lang=fi" xml:lang="smn"/>
</xsl:variable>
