...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=25_itemid=_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=25_itemid=_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=25_itemid=_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=25_itemid=_lang=anaras" xml:lang="smn"/>
</xsl:variable>
