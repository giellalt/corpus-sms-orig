...
<xsl:variable name="para_eng" select="'index.php_option=com_contact_task=view_contact_id=32_itemid=153_lang=english'"/>
<xsl:variable name="para_fin" select="'index.php_option=com_contact_task=view_contact_id=32_itemid=153_lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index.php_option=com_contact_task=view_contact_id=32_itemid=153_lang=davvi'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="''"/>
<xsl:variable name="para_smn" select="'index.php_option=com_contact_task=view_contact_id=32_itemid=153_lang=anaras'"/>
