...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=4_itemid=153_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=4_itemid=153_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=4_itemid=153_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_contact_task=view_contact_id=4_itemid=153_lang=anaras" xml:lang="smn"/>
</xsl:variable>
