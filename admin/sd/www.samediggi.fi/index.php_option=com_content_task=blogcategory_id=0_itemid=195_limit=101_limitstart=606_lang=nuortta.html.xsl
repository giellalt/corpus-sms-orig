...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=0_itemid=195_limit=101_limitstart=606_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=0_itemid=195_limit=101_limitstart=606_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=0_itemid=195_limit=101_limitstart=606_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=0_itemid=195_limit=101_limitstart=606_lang=anaras" xml:lang="smn"/>
</xsl:variable>
