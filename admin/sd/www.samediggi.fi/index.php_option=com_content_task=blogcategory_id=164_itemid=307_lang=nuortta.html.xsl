...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=blogcategory&amp;id=164&amp;Itemid=307&amp;lang=nuortta'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=164_itemid=307_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=164_itemid=307_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=164_itemid=307_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=164_itemid=307_lang=anaras" xml:lang="smn"/>
</xsl:variable>
