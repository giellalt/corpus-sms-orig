...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=229_itemid=364_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=229_itemid=364_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=229_itemid=364_lang=anaras" xml:lang="smn"/>
</xsl:variable>
