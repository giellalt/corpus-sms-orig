...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=90_itemid=122_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=90_itemid=122_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=90_itemid=122_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=blogcategory_id=90_itemid=122_lang=anaras" xml:lang="smn"/>
</xsl:variable>
