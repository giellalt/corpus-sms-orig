...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=blogsection_id=8_itemid=298_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_content_task=blogsection_id=8_itemid=298_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=blogsection_id=8_itemid=298_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=blogsection_id=8_itemid=298_lang=anaras" xml:lang="smn"/>
</xsl:variable>
