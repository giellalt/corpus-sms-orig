...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=category&amp;sectionid=14&amp;id=124&amp;Itemid=195&amp;lang=nuortta'"/>
    ...
    <parallel_text location="index.php_option=com_content_task=category_sectionid=14_id=124_itemid=195_lang=nuortta.html" xml:lang="fin"/>
</xsl:variable>
