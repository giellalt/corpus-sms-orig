...
<xsl:variable name="filename" select="'http://www.samediggi.fi/administrator/index.php?option=com_content&amp;task=view&amp;id=176&amp;Itemid=61&amp;lang=nuortta'"/>
...
<xsl:variable name="para_eng" select="'index.php_option=com_content_task=view_id=176_itemid=61_lang=english'"/>
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=view_id=176_itemid=61_lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index.php_option=com_content_task=view_id=176_itemid=61_lang=davvi'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="''"/>
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=view_id=176_itemid=61_lang=anaras'"/>
