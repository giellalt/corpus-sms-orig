...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=177&amp;Itemid=61&amp;lang=nuortta'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=177_itemid=61_lang=english.html" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_content_task=view_id=177_itemid=61_lang=finnish.html" xml:lang="fin"/>
</xsl:variable>
