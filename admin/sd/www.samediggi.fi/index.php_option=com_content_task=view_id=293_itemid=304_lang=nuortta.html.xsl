...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=293_itemid=304_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=293_itemid=304_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=view_id=293_itemid=304_lang=anaras" xml:lang="smn"/>
</xsl:variable>
