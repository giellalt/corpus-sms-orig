...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=341&amp;Itemid=149&amp;lang=nuortta'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=341_itemid=149_lang=finnish.html" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=341_itemid=149_lang=davvi.html" xml:lang="sme"/>
</xsl:variable>
