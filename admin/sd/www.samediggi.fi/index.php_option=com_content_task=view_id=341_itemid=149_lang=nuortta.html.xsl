...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=341_itemid=149_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=341_itemid=149_lang=davvi" xml:lang="sme"/>
</xsl:variable>
