...
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=view_id=363_itemid=306_lang=finnish'"/>
...
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=view_id=363_itemid=306_lang=anaras'"/>
