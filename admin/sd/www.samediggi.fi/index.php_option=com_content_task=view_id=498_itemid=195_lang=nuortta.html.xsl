...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=498&amp;Itemid=195&amp;lang=nuortta'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=498_itemid=195_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_content_task=view_id=498_itemid=195_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=498_itemid=195_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=view_id=498_itemid=195_lang=anaras" xml:lang="smn"/>
</xsl:variable>
