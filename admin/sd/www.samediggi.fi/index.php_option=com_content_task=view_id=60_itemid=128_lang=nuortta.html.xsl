...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=60&amp;Itemid=128&amp;lang=nuortta'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=60_itemid=128_lang=english.html" xml:lang="eng"/>
	<parallel_text location="index.php_option=com_content_task=view_id=60_itemid=128_lang=finnish.html" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=60_itemid=128_lang=davvi.html" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=view_id=60_itemid=128_lang=anaras.html" xml:lang="smn"/>
</xsl:variable>
