...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=665_itemid=195_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=665_itemid=195_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=view_id=665_itemid=195_lang=anaras" xml:lang="smn"/>
</xsl:variable>
