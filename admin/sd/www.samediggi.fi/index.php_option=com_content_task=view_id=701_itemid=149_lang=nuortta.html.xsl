...
<xsl:variable name="parallels">
	...
	<parallel_text location="index.php_option=com_content_task=view_id=701_itemid=149_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=com_content_task=view_id=701_itemid=149_lang=anaras" xml:lang="smn"/>
</xsl:variable>
