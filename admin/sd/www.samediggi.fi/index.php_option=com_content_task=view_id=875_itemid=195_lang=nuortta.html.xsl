...
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=view_id=875_itemid=195_lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index.php_option=com_content_task=view_id=875_itemid=195_lang=davvi'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="''"/>
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=view_id=875_itemid=195_lang=anaras'"/>
