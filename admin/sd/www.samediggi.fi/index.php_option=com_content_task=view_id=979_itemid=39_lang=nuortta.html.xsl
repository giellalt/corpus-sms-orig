...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=979&amp;Itemid=39&amp;lang=nuortta'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=979_itemid=39_lang=finnish.html" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=979_itemid=39_lang=anaras.html" xml:lang="smn"/>
</xsl:variable>
