...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=979_itemid=39_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=com_content_task=view_id=979_itemid=39_lang=anaras" xml:lang="smn"/>
</xsl:variable>
