...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=registration_task=register_lang=english" xml:lang="eng"/>
	<parallel_text location="index.php_option=registration_task=register_lang=finnish" xml:lang="fin"/>
	<parallel_text location="index.php_option=registration_task=register_lang=davvi" xml:lang="sme"/>
	<parallel_text location="index.php_option=registration_task=register_lang=anaras" xml:lang="smn"/>
</xsl:variable>
