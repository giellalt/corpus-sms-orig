...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index2.php?option=com_contact&amp;task=vcard&amp;contact_id=26&amp;no_html=1&amp;lang=nuortta'"/>
...
<xsl:variable name="para_eng" select="'index2.php_option=com_contact_task=vcard_contact_id=26_no_html=1_lang=english'"/>
<xsl:variable name="para_fin" select="'index2.php_option=com_contact_task=vcard_contact_id=26_no_html=1_lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index2.php_option=com_contact_task=vcard_contact_id=26_no_html=1_lang=davvi'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="''"/>
<xsl:variable name="para_smn" select="'index2.php_option=com_contact_task=vcard_contact_id=26_no_html=1_lang=anaras'"/>
