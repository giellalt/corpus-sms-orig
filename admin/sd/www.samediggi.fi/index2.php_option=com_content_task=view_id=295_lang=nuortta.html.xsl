...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index2.php?option=com_content&amp;task=view&amp;id=295&amp;lang=nuortta.html'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="index2.php_option=com_content_task=view_id=295_lang=finnish.html"/>
        ...
        <parallel_text xml:lang="sme" location="index2.php_option=com_content_task=view_id=295_lang=davvi.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="index2.php_option=com_content_task=view_id=295_lang=anaras.html"/>
