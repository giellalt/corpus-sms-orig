...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://dutkansearvi.fi/satu-moshnikoff-nuorttsaa%CA%B9m%C7%A9ioll-%C7%A9e%CA%B9rjj%C7%A9iollan-da-skooul%C7%A9iollan/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Satu Moshnikoff: Nuõrttsääʹmǩiõll ǩeʹrjjǩiõllân da škooulǩiõllân'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Satu'"/>
    <xsl:variable name="author1_ln" select="'Moshnikoff'"/>
    <!-- m, f or unknown -->
