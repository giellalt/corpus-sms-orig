...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.lundui.fi/se/saamkiolle/vaccar/histoor'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="history_3.html"/>
        <parallel_text xml:lang="fin" location="historia_2.html"/>
        ...
        <parallel_text xml:lang="sme" location="historja_9.html"/>
