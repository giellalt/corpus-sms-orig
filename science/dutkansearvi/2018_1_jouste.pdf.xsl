...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sääʹmǩiõll da kulttuur jeälltummuš Sääʹm mošttbaŋkk -haʹŋǩǩõõzzâst'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Marko'"/>
    <xsl:variable name="author1_ln" select="'Jouste'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Markus'"/>
    <xsl:variable name="author2_ln" select="'Juutinen'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Miika'"/>
    <xsl:variable name="author3_ln" select="'Lehtinen'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author4_fn" select="'Anna'"/>
    <xsl:variable name="author4_ln" select="'Lumikivi'"/>
    <xsl:variable name="author4_gender" select="'f'"/>
    <xsl:variable name="author4_nat" select="'FI'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-25, 31-110'"/>
