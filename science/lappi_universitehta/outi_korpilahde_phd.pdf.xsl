...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://lauda.ulapland.fi/bitstream/handle/10024/62153/Korpilähde_Outi_ActaE_172_pdfA.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kun pohjoisen matkasta tuli elämän mittainen'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Outi'"/>
    <xsl:variable name="author1_ln" select="'Korpilähde'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="outi_korpilahde_phd.pdf"/>
        <parallel_text xml:lang="fin" location="outi_korpilahde_phd.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="outi_korpilahde_phd.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="outi_korpilahde_phd.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-11, 14-377'"/>
    ...
    <xsl:variable name="top_margin" select="'all=10'"/>
