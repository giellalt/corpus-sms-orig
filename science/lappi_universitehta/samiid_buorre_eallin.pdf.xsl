...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Lydia'"/>
    <xsl:variable name="author1_ln" select="'Heikkilä'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Anneli'"/>
    <xsl:variable name="author3_ln" select="'Pohjola'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="samiid_buorre_eallin.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="samiid_buorre_eallin.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location="samiid_buorre_eallin.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-8, 11-200'"/>
    ...
    <xsl:variable name="top_margin" select="'all=12'"/>
